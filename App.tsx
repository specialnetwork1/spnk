...
const notificationSound = new Audio('data:audio/mpeg;base64,-');
...
const App: React.FC = () => {
        ...
        const fetchData = async () => {
            ...
            try {
                const [
                    ...
                    supabase.from('tournaments').select('*').abortSignal(signal),
                    supabase.from('transactions').select('*').abortSignal(signal),
                    supabase.from('notifications').select('*').abortSignal(signal),
                    // FIX: Moved `abortSignal` before `single` because `single` returns a promise-like object, not the query builder.
                    supabase.from('app_settings').select('*').limit(1).abortSignal(signal).single()
                ]);
    ...
    const handleAddMoney = async (amount: number, trxId: string, referenceNumber: string, gatewayName: string) => {
        if (!currentUser) return;
        
        // 1. Instantly update user balance in DB
        ...
        if (userError || !updatedUser) {
            handleError(userError || new Error("Failed to update balance"), "auto-approving deposit");
            // Optional: Revert balance update or handle error more gracefully
            return;
        }
        ...
        const newTransactionData = {
            ...
            amount,
            senderNumber: gatewayName, // We can repurpose this field for the gateway name
            trxId: trxId,
            referenceNumber: referenceNumber,
            status: TransactionStatus.Approved, // Auto-approved
            date: new Date().toISOString(),
        };
        const { data: insertedTx, error: txError } = await supabase.from('transactions').insert(newTransactionData).select().single();

        if (txError) {
            handleError(txError, "logging approved transaction");
            // The user balance was updated, but the transaction log failed. This is an inconsistent state.
            // For a real app, this would require a more robust error handling/reconciliation strategy.
        }
        ...
        showModal(t('paymentSuccessful'), 'success');
    };
    ...
    const renderPage = () => {
        ...
        switch (currentPage) {
            case 'home':
                return <HomePage tournaments={tournaments} onViewDetails={viewTournamentDetail} currentUser={currentUser} onNavigate={navigate} users={users} />;
            case 'login':
