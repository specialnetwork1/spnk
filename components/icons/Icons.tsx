...
export const UsersIcon: React.FC<{className?: string}> = ({className = "h-5 w-5 text-primary"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const MapIcon: React.FC<{className?: string}> = ({className = "h-5 w-5 text-primary"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 16.382V5.618a1 1 0 00-1.447-.894L15 7m-6 13v-8" />
    </svg>
);

export const CalendarIcon: React.FC<{className?: string}> = ({className = "h-5 w-5 text-primary"}) => (
     <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
    </svg>
);

export const TrophyIcon: React.FC<{className?: string}> = ({className = "h-5 w-5 text-yellow-500 dark:text-yellow-400"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 11l3-3m0 0l3 3m-3-3v8m0-13a9 9 0 110 18 9 9 0 010-18zm0 18a9 9 0 100-18 9 9 0 000 18z" />
    </svg>
);
...
export const TransactionIcon: React.FC<{className?: string}> = ({className = "h-5 w-5"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const IdentificationIcon: React.FC<{ className?: string }> = ({ className = 'h-5 w-5' }) => (
     <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 012-2h4a2 2 0 012 2v1m-4 0h4m-9 4h1m0 4h1m4-4h1m0 4h1" />
    </svg>
);
...
export const DiscordIcon: React.FC<{ className?: string }> = ({ className = 'h-6 w-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M19.54 0c1.356 0 2.46 1.104 2.46 2.472v21.528l-2.58-2.28-1.452-1.344-1.536-1.428.636 2.22h-13.62c-1.356 0-2.46-1.104-2.46-2.472v-16.224c0-1.368 1.104-2.472 2.46-2.472h16.068zm-4.632 14.652c0 .816-.672 1.488-1.488 1.488s-1.488-.672-1.488-1.488v-.096c-1.152.42-2.364.768-3.6.996v.636c0 .816-.672 1.488-1.488 1.488s-1.488-.672-1.488-1.488v-4.98c0-.816.672-1.488 1.488-1.488s1.488.672 1.488 1.488v2.232c1.452-.444 2.808-.924 4.044-1.38v.204c0 .816.672 1.488 1.488 1.488s1.488-.672 1.488-1.488v-2.304c0-.816-.672-1.488-1.488-1.488s-1.488.672-1.488 1.488v.828c-1.2.324-2.352.72-3.456 1.152v-2.052c0-.816-.672-1.488-1.488-1.488s-1.488.672-1.488 1.488v6.108c-1.164-.264-2.256-.6-3.264-.996v-.864c0-.816-.672-1.488-1.488-1.488s-1.488.672-1.488 1.488v2.304c0 .816.672 1.488 1.488 1.488s1.488-.672 1.488-1.488v-1.14c.936.324 1.86.696 2.748 1.056v2.196c0 .816.672 1.488 1.488 1.488s1.488-.672 1.488-1.488v-2.7c1.332-.396 2.604-.876 3.792-1.428v1.356z"/>
    </svg>
);
...
export const CrownIcon: React.FC<{ className?: string }> = ({ className = 'h-5 w-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path d="M11.983 1.924a1 1 0 00-1.966 0L9.12 6.097a1 1 0 01-.942.69h-4.43a1 1 0 00-.977 1.216l1.52 5.488a1 1 0 00.976.789h8.484a1 1 0 00.976-.789l1.52-5.488a1 1 0 00-.977-1.216h-4.43a1 1 0 01-.942-.69L11.983 1.924zM10 16a1 1 0 100-2 1 1 0 000 2z" />
        <path fillRule="evenodd" d="M3 18a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" />
    </svg>
);
